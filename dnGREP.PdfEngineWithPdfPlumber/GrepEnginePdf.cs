...
namespace dnGREP.Engines.PdfPlumber
{
    ...
    /// </summary>
    public class GrepEnginePdfPlumber : GrepEngineBase, IGrepPluginEngine
    {
        ...
        public override bool Initialize(GrepEngineInitParams param, FileFilter filter)
        {
            ...
            try
            {
                ...
                pathToPdfToText = "python3";
                return true;
                // Make sure pdftotext.exe exists
                //pathToPdfToText = Path.Combine(Utils.GetCurrentPath(typeof(GrepEnginePdfPlumber)), "xpdf", "pdftotext.exe");
            ...
            {
                logger.Error(ex, "Failed to find python3");
                return false;
            }
        }
        ...
        private string ExtractText(string pdfFilePath)
        {
            ...
            process.StartInfo.Arguments = string.Format(" pdf.py \"{1}\" \"{2}\"", null, longPdfFilePath, tempFileName);
            process.StartInfo.UseShellExecute = false;
            process.StartInfo.WorkingDirectory = Path.Combine(Utils.GetCurrentPath(typeof(GrepEnginePdfPlumber)));
            ...
            else
            {
                ...
                throw new PdfPlumberException(TranslationSource.Format(Localization.Properties.Resources.Error_PdftotextReturned0Reading1, errorMessage, pdfFilePath));
            }
        }
